...
<html lang="en">
    ...
    <body>
        ...
        <nav class="admin-navbar">
            <ul class="admin-navbar__list">
                <div class="top-act__user top-act__btn-wrap">
                    ...
                    <img src="" alt="" class="top-act__avatar" />
                    <!-- Dropdown -->
                            ...
                            <ul class="user__dropdown-list">
                                <li class="user__dropdown-item">
                                    <span class="user__dropdown-text-wrap">
                                        ...
                                        <span class="user__dropdown-text"></span>
                                    </span>
                                </li>
        ...
        <main class="main">
            <div class="admin-top">
                ...
                <form action="storage.jsp" method="POST" class="search-bar d-flex admin__search-bar">
                    <input
                        type="text"
                        name="data-search"
                        id=""
                ...
                <a href="./storage-add" class="admin__add-btn">+ Add Storage</a>
            </div>              
            <table class="table">
                <thead class="table__head">
                    <tr>
                        ...
                        <th class="table__heading">Remove</th>
                    </tr>
                </thead>
                <tbody>
                    <c:set var="S"></c:set>              
                    <c:forEach items="${requestScope.listS}" var="S">
                        <tr>
                            <td>
                                <p class="table__data">${S.id}</p>
                            </td>
                            <td>
                                <p class="table__data">${S.name}</p>
                            </td>

                            <td>
                                <p class="table__data">${S.size}</p>
                            </td>

                            <td>
                                <p class="table__data">${S.address}</p>
                            </td>

                            <td>
                                <p class="table__data">${S.type}</p>
                            </td>

                            <td>
                                <p class="table__data">${S.status}</p>
                            </td>

                            <td>
                                <div class="table__act">
                                    <a href="./StorageUpdateControl?id=${S.id}" class="table__act-btn table__act-btn-edit" title="edit">
                                        <svg
                                            fill="rgb(143, 159, 188)"
                                            xmlns="http://www.w3.org/2000/svg"
                                            height="1em"
                            ...
                            <td>
                                <div class="table__act">                               
                                     ...
                                     <button  class="table__act-btn table__act-btn-remove js-toggle" data-id="${S.id}" id="btn-del" toggle-target="#delete-confirm"  title="remove">
                                        <svg
                                            fill="#fff"
                                            xmlns="http://www.w3.org/2000/svg"
                                            height="1em"
            ...
            <div class="paging">
                <div class="paging-info">
                    Showing <span class="paging-start"><</span> to <span class="paging-end"></span> of <span class="paging-total"></span> entries
                </div>
                <ul class="paging__list">
                    ...
                    <li class="paging__item ">
                        <a class="paging__link" href="admin.jsp?index="><img src="./assets/icons/previous.svg" class="icon" alt=""></a>
                    </li>
                    <li class="paging__item  paging__item--active"><a class="paging__link"></a></li>
                    <li class="paging__item ">
                        <a class="paging__link" href="admin.jsp?index="><img src="./assets/icons/next.svg" class="icon" alt=""></a>
                    </li>
                    <li class="paging__item ">
                        <a class="paging__link" href="admin.jsp?index="><svg class="icon" xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.--><path d="M470.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 256 265.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160zm-352 160l160-160c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L210.7 256 73.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0z"/></svg></a>
                    </li>
                </ul>
            </div>
        </main>
    ...
    <script>
        function handleDelete(e) {
            if (curID)
                window.location.href = './StorageDeleteController?id=' + curID;
        }
    </script>
