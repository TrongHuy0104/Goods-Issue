                ...
                <li class="admin-navbar__item">
                    <a href="#!" class="admin-navbar__link">
                        <img
                            ...
                            />
                        <span class="admin-navbar__text"></span>
                    </a>
                </li>
            </ul>
        </nav>
        ...
        <main class="auth main">
            ...
            <div id="auth-content" class="auth__content">
                <div class="auth__content-inner admin-content-inner">
                    ...
                    <p class="form__title">STORAGE UPDATE INFORMATION</p>
                    <form
                        action="StorageUpdateControl"
                        method="POST"
                        ...
                        <div class="col">
                            ...
                            <div class="form__group">
                                <div class="form__text-input">
                                    <input
                                        type="text"
                                        placeholder="${requestScope.s.name}"
                                        class="form__input"
                                        name="storageName"
                            ...
                            <div class="form__group">
                                <div class="form__text-input">
                                    <input
                                        type="number"
                                        placeholder="${requestScope.s.size}"
                                        class="form__input"
                                        name="size"
                                        value="${requestScope.s.size}"
                            ...
                            <div class="form__group">
                                <div class="form__text-input">
                                    <input
                                        type="text"
                                        placeholder="${requestScope.s.address}"
                                        class="form__input"
                                        name="address"
                        ...
                        <div class="col">
                            <div class="form__group">
                                <div class="form__text-input">
                                    <input
                                        type="text"
                                        placeholder="${requestScope.s.type}"
                                        class="form__input"
                                        name="type"
                            ...
                            <div class="form__group">
                                <div class="form__text-input">
                                    <input
                                        type="text"
                                        placeholder="${requestScope.s.status}"
                                        class="form__input"
                                        name="status"
